...
namespace ECommerce.Data.Migrations
{
    ...
    [Migration("20200502130925_Product")]
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Title", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Active = true, CreateDate = new DateTime(2020, 5, 2, 13, 9, 25, 346, DateTimeKind.Utc), Deleted = false, Name = "Müşteri" },
                        new { Id = 2, Active = true, CreateDate = new DateTime(2020, 5, 2, 13, 9, 25, 346, DateTimeKind.Utc), Deleted = false, Name = "Yönetici" }
                    );
                });
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Active = true, Admin = true, CreateDate = new DateTime(2020, 5, 2, 13, 9, 25, 346, DateTimeKind.Utc), Deleted = false, Email = "admin@admin.com", EmailVerified = true, Name = "Admin", Password = "7C222FB2927D828AF22F592134E8932480637C0D", Surname = "Admin", TitleId = 2 }
                    );
                });
